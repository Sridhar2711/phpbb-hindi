...
$lang = array_merge($lang, array (
  ...
  'ADMIN_PASSWORD_CONFIRM' => 'प्रशासक पासवर्ड की पुष्टि',
  'ADMIN_PASSWORD_EXPLAIN' => '6 और 30 वर्णों के बीच एक पासवर्ड दर्ज करें.',
  'ADMIN_TEST' => 'प्रशासक सेटिंग्स की जाँच करें',
  'ADMIN_USERNAME' => 'प्रशासक उपयोगकर्ता नाम',
  'ADMIN_USERNAME_EXPLAIN' => '3 और 20 अक्षरों के बीच एक उपयोगकर्ता नाम दर्ज करें.',
  'APP_MAGICK' => 'ImageMagick समर्थन [अनुलग्नक]',
  'AUTHOR_NOTES' => 'लेखक नोट<br />» %s',
  'AVAILABLE' => 'उपलब्ध',
  'AVAILABLE_CONVERTORS' => 'उपलब्ध कन्वर्टर्स',
  'BEGIN_CONVERT' => 'रूपांतरण शुरू',
  'BLANK_PREFIX_FOUND' => 'A scan of your tables has shown a valid installation using no table prefix.',
  'BOARD_NOT_INSTALLED' => 'इन्स्तौलेशन नहीं मिला ',
  ...
  'CONTINUE_UPDATE' => 'Continue update now',
